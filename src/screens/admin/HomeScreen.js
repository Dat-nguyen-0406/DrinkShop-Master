...
const categoriesData = [
  { id: '1', name: 'Cà phê', image: require('../../assets/icon.png') },
  { id: '2', name: 'Trà sữa', image: require('../../assets/icon.png') },
  { id: '3', name: 'Nước ép', image: require('../../assets/icon.png') },
  { id: '4', name: 'Sinh tố', image: require('../../assets/icon.png') },
  { id: '5', name: 'Trà', image: require('../../assets/icon.png') },
];

// Mock data for popular drinks
const popularDrinksData = [
  { id: '1', name: 'Cà phê sữa đá', price: 29000, rating: 4.8, image: require('../../assets/icon.png') },
  { id: '2', name: 'Trà sữa trân châu', price: 35000, rating: 4.7, image: require('../../assets/icon.png') },
  { id: '3', name: 'Sinh tố xoài', price: 39000, rating: 4.5, image: require('../../assets/icon.png') },
  { id: '4', name: 'Nước ép cam', price: 32000, rating: 4.6, image: require('../../assets/icon.png') },
  { id: '5', name: 'Trà đào', price: 30000, rating: 4.9, image: require('../../assets/icon.png') },
];
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
            ...
            {promotionsData.map((_, index) => (
              <View
                ...
                style={[
                  ...
                  index === activePromotion && styles.paginationDotActive,
                ]}
              />
            ))}
          </View>
        ...
        <View style={styles.sectionContainer}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('DrinkList', { filter: 'popular' })}>
              <Text style={styles.seeAllText}>Xem tất cả</Text>
            </TouchableOpacity>
          </View>
          <FlatList
        ...
        <View style={[styles.sectionContainer, { marginBottom: 20 }]}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('DrinkList', { filter: 'recommended' })}>
              <Text style={styles.seeAllText}>Xem tất cả</Text>
            </TouchableOpacity>
          </View>
          <FlatList
